...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_2", new String[]{"Pregunta 2.1 - ", "Cuantos años tienes? ?", "Pregunta 2.3 - Te gustan las hamburguesas? 🍔🍟"});
        preguntas.put("SECTION_3", new String[]{"Pregunta 3.1 - Tienes hambre?", "Pregunta 3.2 - Te gusta el futbol? ⚽", "Pregunta 3.3 - Te gusta Messi? 🐐"});
        preguntas.put("SECTION_4", new String[]{"Pregunta 4.1- Juegas Fortnite? ⚔️", "Pregunta 4.2- Juegas en modo sin construcción? 👍", "Pregunta 3.3 - Sale pvp? 🥷"});
    }
